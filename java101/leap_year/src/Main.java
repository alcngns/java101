...
This extra day (leap day) is obtained by adding February 29 to February, which normally has 28 days.
...
public class Main {
    public static void main(String[] args) {
        int year;
        String msg = " is a leap year.", msg2 = " is not a leap year.";
        Scanner inp = new Scanner(System.in);

        System.out.print("Please enter the year to be calculated: ");
        year = inp.nextInt();
